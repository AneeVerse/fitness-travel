    ...
    <section className="relative py-20 bg-gray-100">
      <div className="max-w-[1325px] mx-auto px-4 sm:px-8">
        <div className="text-center mb-10">
          <span className="inline-block px-3 py-1 rounded-full bg-black/50 text-[#98ff98] text-xs tracking-wider uppercase mb-4">
            - Upcoming Events -
          </span>
              ...
              {/* Left ticket column */}
                ...
                <div>
                    ...
                    <div className="mt-3 flex items-baseline gap-2 whitespace-nowrap">
                                                              <span className="text-5xl font-extrabold text-[#98ff98]">{event.priceLabel}</span>
                      <span className="text-sm text-white">/ Ticket</span>
                  </div>
                </div>
                                                  <button
                    className="mt-8 inline-flex items-center justify-center rounded-full bg-[#98ff98] px-5 py-2.5 text-base md:text-lg font-semibold text-black hover:bg-[#7aff7a] transition-colors uppercase tracking-wide"
              ...
              {/* Middle content */}
                <div className="lg:col-span-6 p-8 lg:border-r lg:border-gray-200">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="inline-flex h-5 w-5 items-center justify-center text-[#98ff98]">
        ...
        <div className="flex justify-center mt-10">
          <button className="px-6 py-3 rounded-full bg-black text-[#98ff98] font-semibold hover:bg-gray-900 uppercase">
            View More Events
          </button>
        </div>
      </div>
