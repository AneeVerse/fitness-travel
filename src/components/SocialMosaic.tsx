...
const SocialMosaic: React.FC = () => {
  return (
    <section id="social-mosaic" className="py-12 sm:py-14 md:py-15 lg:py-16 bg-[#ef4a25] mobile-section">
      <div className="px-2 sm:px-3 md:px-4 lg:px-6 xl:px-8 max-w-[1380px] mx-auto">
        ...
        <div className="block sm:hidden">
          <div className="columns-2 gap-3 space-y-3">
            ...
            <div className="rounded-xl bg-white text-black p-4 break-inside-avoid mb-3 shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center" style={{ minHeight: '160px' }}>
              <a
            ...
            {/* Instagram Card - Small Tablet Optimized - Hidden on Mobile */}
            <div className="hidden xs:block rounded-xl bg-white text-black p-6 break-inside-avoid mb-4 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center" style={{ minHeight: '180px' }}>
              <a
                href="https://www.instagram.com/tigerterrain.in"
                target="_blank"
                rel="noopener noreferrer"
