...
const SocialMosaic: React.FC = () => {
  return (
    <section id="social-mosaic" className="py-12 sm:py-14 md:py-15 lg:py-16 bg-[#244447] mobile-section">
      <div className="mx-4 sm:mx-6 md:mx-8 lg:mx-12 xl:mx-16">
        ...
        <div className="block sm:hidden">
          <div className="columns-2 gap-3 space-y-3">
            ...
            <div className="rounded-xl bg-gradient-to-br from-[#ef4a25] to-[#d65a1a] text-white p-6 break-inside-avoid mb-3 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center" style={{ minHeight: '160px' }}>
              <a
        ...
        <div className="hidden sm:block md:hidden">
          <div className="columns-2 gap-4 space-y-4">
            ...
            <div className="rounded-xl bg-gradient-to-br from-[#ef4a25] to-[#d65a1a] text-white p-6 break-inside-avoid mb-4 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center" style={{ minHeight: '180px' }}>
              <a
                href="https://www.instagram.com/tigerterrain.in"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="hidden md:block xl:hidden">
          <div className="columns-3 gap-4 space-y-4">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-[#ef4a25] to-[#d65a1a] text-white p-6 break-inside-avoid mb-4 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center" style={{ minHeight: '200px' }}>
              <a
                href="https://www.instagram.com/tigerterrain.in"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="hidden xl:grid xl:grid-cols-3 gap-6">
          ...
          <div className="rounded-3xl bg-gradient-to-br from-[#ef4a25] to-[#d65a1a] text-white p-8 sm:p-10 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300">
            <a
              href="https://www.instagram.com/tigerterrain.in"
              target="_blank"
              rel="noopener noreferrer"
