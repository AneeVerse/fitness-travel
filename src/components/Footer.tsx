        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                ...
                {/* Column 2 */}
                <div className="space-y-3">
                  <Link href="/contact" className="text-gray-300 hover:text-white transition-colors duration-200 text-sm py-2 border-l-2 border-gray-700 hover:border-orange-500 pl-3 hover:pl-4 transition-all duration-200 block">
                    Contact
                  </Link>
          ...
          <div className="flex justify-center mt-12">
            <div className="flex space-x-6">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/919820942632" target="_blank" rel="noopener noreferrer" className="text-white hover:text-green-400 transition-colors duration-200 p-2 hover:bg-gray-800 rounded-full">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
