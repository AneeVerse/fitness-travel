    ...
    <footer className="mt-16 sm:mt-24 mobile-footer">
      ...
      <div className="block md:hidden">
        ...
        <div className="px-6 py-8 text-center">
          ...
          <div className="flex items-center justify-center gap-4 mb-6 ">
            <Link href="https://www.instagram.com/tigerterrain.in" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 rounded-full bg-[#e77d25] text-white flex items-center justify-center hover:bg-black transition-colors">
            ...
            <Link href="mailto:team.tigerterrain@gmail.com" aria-label="Email" className="w-10 h-10 rounded-full bg-[#e77d25] text-white flex items-center justify-center hover:bg-black transition-colors">
      ...
      <div className="hidden md:block xl:hidden">
        ...
        <div className="px-8 py-10 space-y-0">
            ...
            <div className="py-6 space-y-4 border-b border-gray-200">
              <div className="grid grid-cols-2 gap-8">
                <div className="space-y-3">
                  <Link href="/" className="block text-gray-600 hover:text-[#e77d25] transition-colors text-lg">Home</Link>
                  <Link href="/about-us" className="block text-gray-600 hover:text-[#e77d25] transition-colors text-lg">About</Link>
                  <Link href="/programs" className="block text-gray-600 hover:text-[#e77d25] transition-colors text-lg">Upcoming Events</Link>
                </div>
                <div className="space-y-3">
                  <Link href="/pages" className="block text-gray-600 hover:text-[#e77d25] transition-colors text-lg">Blogs</Link>
                  <Link href="/contact" className="block text-gray-600 hover:text-[#e77d25] transition-colors text-lg">Contact</Link>
                </div>
              </div>
            </div>
          )}
          ...
          {isServicesOpen && (
            <div className="py-6 space-y-4 border-b border-gray-200">
              <div className="grid grid-cols-2 gap-8">
                <div className="space-y-3">
                  <Link href="#" className="block text-gray-600 hover:text-[#e77d25] transition-colors text-lg">Past Events</Link>
                  <Link href="#" className="block text-gray-600 hover:text-[#e77d25] transition-colors text-lg">Gallery</Link>
                </div>
                <div className="space-y-3">
                  <Link href="#" className="block text-gray-600 hover:text-[#e77d25] transition-colors text-lg">Feedback</Link>
                  <Link href="#" className="block text-gray-600 hover:text-[#e77d25] transition-colors text-lg">Team</Link>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="px-8 py-10 text-center">
          <h2 className={`text-5xl tracking-wide font-bold text-[#e77d25] mb-6`}>
            <span className={tigerTerrainFont.className}>TIGER TERRAIN</span>
          </h2>
          ...
          <div className="flex items-center justify-center gap-6 mb-8">
            <Link href="https://www.instagram.com/tigerterrain.in" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-12 h-12 rounded-full bg-[#e77d25] text-white flex items-center justify-center hover:bg-black transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
              </svg>
            </Link>
            <Link href="mailto:team.tigerterrain@gmail.com" aria-label="Email" className="w-12 h-12 rounded-full bg-[#e77d25] text-white flex items-center justify-center hover:bg-black transition-colors">
          ...
          <div className="pt-6 border-t border-gray-200">
            <Link href="https://www.aneeverse.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-3 text-sm text-gray-500 hover:text-[#e77d25] transition-colors">
              <span>Designed & Managed by Aneeverse</span>
        ...
        <div className="max-w-[1325px] mx-auto px-4 sm:px-8 py-8 sm:py-12 space-y-8 md:space-y-0 md:grid md:[grid-template-columns:300px_1fr_1fr] md:gap-12 md:gap-16 md:items-start text-[#244447]">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start gap-3 text-[#244447] mobile-social ml-12">
              ...
              <Link href="mailto:team.tigerterrain@gmail.com" aria-label="Email" className="w-9 h-9 rounded-full bg-[#e77d25] text-white flex items-center justify-center ring-1 ring-1 ring-[#244447]/20 hover:bg-[#e77d25] transition-colors"><IconMail className="w-4 h-4" /></Link>
            </div>
          </div>
